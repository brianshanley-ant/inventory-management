...
.legend-dot.procurement { background: var(--brand-emphasized); }
.legend-dot.operational { background: var(--accent); }
...
.bar-segment.procurement { background: var(--brand-emphasized); }
.bar-segment.operational { background: var(--accent); }
